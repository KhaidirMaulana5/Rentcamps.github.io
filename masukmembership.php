...
<body background="./image/bg-login.png">
    ...
    <div id="register">
      <div id="content">
        ...
        <form action="" method="POST">
          ...
          <div class="submit">
            <input name="masuk" type="submit" value="MASUK" href="profil.php">
          </div>
          <div class="question"> belum membership? <a href="daftarmembership.php">DAFTAR</a></div>
        </form>
      </div>
    </div>
  </div>
  ...
  if (isset($_POST['masuk'])) {
    ...
    $sql = "SELECT * FROM membership WHERE email = '$email' AND pasword = '$pasword'";
    ...
    } else if ($email == '' or $pasword == '') {
      echo "Email or Password cannot be empty";
    } else if ("email" != $email or "password" != $pasword) {
